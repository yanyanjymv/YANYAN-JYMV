...
<div class="sidebar">
       ...
       <div id="current-time" style="text-align: center; margin-bottom: 20px; font-size: 20px;"></div>
        ...
        ?> 
            ...
            <li><a href="approval_cuti_marketing.php"><i class="fas fa-check-circle"></i> Approval Cuti</a></li>
            <li><a href="approval_izin_marketing.php"><i class="fas fa-check"></i> Approval Izin Kerja</a></li>
    ...
    <div class="content">
<div class="box">
    <h1>Approval Izin Kerja MARKETING</h1>
    <table class="data-table">
        ...
        <?php
        $sql = "SELECT * FROM izin where `departement`='MARKETING' and `status` in ('Pending Spv Approval');";
            ...
            while ($row = $result->fetch_assoc()) {
                echo "<tr>
                        ...
                        <td>
                            ...
                            <a href='update_status_izin.php?id={$row['id']}&status=Pending Admin Approval'>Approve</a>
                            </button> | 
                            <button class='reject'>
