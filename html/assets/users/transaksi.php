	...
	<body>
		...
		<div class="table-responsive" >
			...
			<table class="table" align="center" width="100%">
				...
				<?php 
				$querycash = mysqli_query($konekdb, "SELECT * from tb_cash where id_pembeli = '$id_show' ");
				...
				while($data1 = mysqli_fetch_array($querycash)){
				$mobil = $data1['id_mobil'];
				
				
				$querymobil = mysqli_query($konekdb, "SELECT * from tb_mobil where id_mobil = '$mobil' ");
				$data2 = mysqli_fetch_array($querymobil);
		...
		*Ketentuan & Cara Pembelian Cash :	
		...
		<div class="table-responsive" >
			...
			<table class="table" align="center" width="100%">
				...
				<?php
				$querykredit = mysqli_query($konekdb, "SELECT * from tb_kredit where id_pembeli = '$id_show' ");

				if (!$querykredit) {
					die("Query gagal: " . mysqli_error($konekdb));
				}
				if (mysqli_num_rows($querykredit) == 0) {
					echo "Tidak ada data transaksi kredit.";
				} else {
					while ($data3 = mysqli_fetch_array($querykredit)) {
				...
				$querymobil = mysqli_query($konekdb, "SELECT * from tb_mobil where id_mobil = '$mobil' ");
				$data4 = mysqli_fetch_array($querymobil);
