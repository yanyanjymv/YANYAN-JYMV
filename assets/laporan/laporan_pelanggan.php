...
$hasil = mysqli_query($konekdb, "SELECT * from tb_pembeli order by id_beli asc") or die (mysql_error());
$kolom_idbeli = "";
$kolom_idpembeli = "";
$kolom_namapembeli = "";
$kolom_tglbeli = "";
...
$pdf->Cell(130);
$pdf->Cell(30,5,'CV. Alimrugi Car Shop',0,0,'C');
$pdf->Ln();
...
$pdf->SetFont('Times','',11);
$pdf->Cell(130);
$pdf->Cell(30,5,'No Telp : 085-113-532-123 Fax : 1123-4123 email: Alimrugi@yahoo.com',0,0,'C');
$pdf->Ln();
