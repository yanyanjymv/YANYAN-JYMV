...
if (!isset($_POST['nama_user'], $_POST['jk_user'], $_POST['alamat_user'], $_POST['notelp_user'], $_POST['alamat_email'])) {
...
$alamat_user = mysqli_real_escape_string($konekdb, $_POST['alamat_user']);
$notelp_user = mysqli_real_escape_string($konekdb, $_POST['notelp_user']);
...
if (mysqli_num_rows($cek_user) > 0) {
    ...
    $query = "INSERT INTO tb_bio (id_user, nama_user, jk_user, alamat_user, notelp_user, alamat_email) 
        VALUES ('$id_user', '$nama_user', '$jk_user', '$alamat_user', '$notelp_user', '$alamat_email')";
}
